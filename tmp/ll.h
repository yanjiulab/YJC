...
static inline void slist_del_head(struct slist_head *list) { slist_del_after(&list->first, list); }
...
#define slist_entry(ptr, type, member) ((type *)((char *)(ptr) - (size_t)(&((type *)0)->member)))
