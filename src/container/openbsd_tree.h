...
#define RB_PROTOTYPE(_name, _type, _field, _cmp)                                                                       \
    ...
    __attribute__((__unused__)) static inline void _name##_RB_INIT(                                                    \
        ...
        _rb_init(&head->rbh_root);                                                                                     \
                                                                                                                       ...
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_INSERT(struct _name* head, struct _type* elm) { \
        return (struct _type*)_rb_insert(_name##_RB_TYPE,                                                              \
                                         &head->rbh_root, elm);                                                        \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_REMOVE(struct _name* head, struct _type* elm) { \
        return (struct _type*)_rb_remove(_name##_RB_TYPE,                                                              \
                                         &head->rbh_root, elm);                                                        \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_FIND(const struct _name* head,                  \
                                                                            const struct _type* key) {                 \
        return (struct _type*)_rb_find(_name##_RB_TYPE,                                                                \
                                       &head->rbh_root, key);                                                          \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_NFIND(const struct _name* head,                 \
                                                                             const struct _type* key) {                \
        return (struct _type*)_rb_nfind(_name##_RB_TYPE,                                                               \
                                        &head->rbh_root, key);                                                         \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_ROOT(const struct _name* head) {                \
    ...
    __attribute__((__unused__)) static inline int _name##_RB_EMPTY(                                                    \
        ...
        return _rb_empty(&head->rbh_root);                                                                             \
                                                                                                                       ...
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_MIN(const struct _name* head) {                 \
        return (struct _type*)_rb_min(_name##_RB_TYPE,                                                                 \
                                      &head->rbh_root);                                                                \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_MAX(const struct _name* head) {                 \
        return (struct _type*)_rb_max(_name##_RB_TYPE,                                                                 \
                                      &head->rbh_root);                                                                \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_NEXT(struct _type* elm) {                       \
        return (struct _type*)_rb_next(_name##_RB_TYPE, elm);                                                          \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_PREV(struct _type* elm) {                       \
        return (struct _type*)_rb_prev(_name##_RB_TYPE, elm);                                                          \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_LEFT(struct _type* elm) {                       \
        return (struct _type*)_rb_left(_name##_RB_TYPE, elm);                                                          \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_RIGHT(struct _type* elm) {                      \
        return (struct _type*)_rb_right(_name##_RB_TYPE, elm);                                                         \
    }                                                                                                                  \
                                                                                                                       \
    __attribute__((__unused__)) static inline struct _type* _name##_RB_PARENT(struct _type* elm) {                     \
